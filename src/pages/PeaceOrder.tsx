    ...
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <main className="pt-8 pb-16">
        ...
        <section className="text-center py-16 px-6 bg-gradient-to-br from-[#1e3a8a] to-[#475569] text-white">
          ...
          <button className="mt-8 bg-white text-[#1e3a8a] rounded-full px-8 py-3 font-semibold shadow-md hover:scale-105 hover:brightness-110 focus:ring-2 focus:ring-white/50 transition-all duration-150">
            Promote Safety
          </button>
        </section>
